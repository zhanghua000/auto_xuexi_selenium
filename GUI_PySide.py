...
from PySide6.QtGui import QIntValidator, QMouseEvent, QPixmap
from PySide6.QtCore import QObject, QThread, Qt, Signal, QTimer
from PySide6.QtWidgets import QCheckBox, QDialog, QFileDialog, QHBoxLayout, QListWidget, QTabWidget, QWidget, QGridLayout, QVBoxLayout, QPushButton, QLabel, QPlainTextEdit, QLineEdit, QSlider
os.chdir(os.path.split(os.path.realpath(__file__))[0])
class InputWindow(QDialog):
    def __init__(self,data:str,emit_signal:Signal,parent:QWidget):
        super().__init__()
...
class SettingWindow(QDialog):
    def __init__(self,parent:QWidget):
        ...
        self.theme_opacity_slider.setOrientation(Qt.Orientation.Horizontal)
...
class Work(QObject):
    signal=Signal(bytes)
    scan_signal=Signal(bool)
    can_quit=Signal()
    need_input_signal=Signal(str)
