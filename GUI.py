...
class SettingWindow(QDialog):
    def __init__(self,parent=None):
        ...
        allow_upload=QCheckBox("自动上传数据库")
        allow_upload.setChecked(conf["allow_upload"])
        allow_upload.setStyleSheet(settings["check_box"])
        tab_main_layout.addWidget(allow_upload,0,0)
        browser_exec=QHBoxLayout()
        browser_exec_label=QLabel("浏览器可执行程序路径：")
        browser_exec_label.setStyleSheet(settings["label"])
        browser_exec_edit=QLineEdit()
        browser_exec_edit.setText(conf["browser_exec"])
        browser_exec_edit.setStyleSheet(settings["text_edit"])
        browser_exec.addWidget(browser_exec_label)
        browser_exec.addWidget(browser_exec_edit)
        ...
        browser_type_edit=QLineEdit()
        browser_type_edit.setText(conf["browser_type"])
        browser_type_edit.setStyleSheet(settings["text_edit"])
        browser_type.addWidget(browser_type_label)
        browser_type.addWidget(browser_type_edit)
        ...
        driver_exec_edit=QLineEdit()
        driver_exec_edit.setText(conf["driver_exec"])
        driver_exec_edit.setStyleSheet(settings["text_edit"])
        driver_exec.addWidget(driver_exec_label)
        driver_exec.addWidget(driver_exec_edit)
        ...
        if conf["browser_type"]=="edge_chromium":
            ...
            edge_version_edit=QLineEdit()
            edge_version_edit.setText(conf["edge_version"])
            edge_version_edit.setStyleSheet(settings["text_edit"])
            edge_version.addWidget(edge_version_label)
            edge_version.addWidget(edge_version_edit)
            tab_main_layout.addLayout(edge_version,4,0)
        enable_daily_test=QCheckBox("启用每日测验")
        enable_daily_test.setChecked(conf["enable_daily_test"])
        enable_daily_test.setStyleSheet(settings["check_box"])
        tab_main_layout.addWidget(enable_daily_test,0,1)
        enable_gui=QCheckBox("启用图形界面")
        enable_gui.setChecked(conf["enable_gui"])
        enable_gui.setStyleSheet(settings["check_box"])
        tab_main_layout.addWidget(enable_gui,1,1)
        enable_special_test=QCheckBox("启用专项测验")
        enable_special_test.setChecked(conf["enable_special_test"])
        enable_special_test.setStyleSheet(settings["check_box"])
        tab_main_layout.addWidget(enable_special_test,2,1)
        enable_weekly_test=QCheckBox("启用每周测验")
        enable_weekly_test.setChecked(conf["enable_weekly_test"])
        enable_weekly_test.setStyleSheet(settings["check_box"])
        tab_main_layout.addWidget(enable_weekly_test,3,1)
        is_debug=QCheckBox("启用调试模式")
        is_debug.setChecked(conf["is_debug"])
        is_debug.setStyleSheet(settings["check_box"])
        tab_main_layout.addWidget(is_debug,4,1)
        lang=QHBoxLayout()
        # 有翻译系统后把文本框换成下拉框
        lang_label=QLabel("语言：")
        lang_label.setStyleSheet(settings["label"])
        lang_edit=QLineEdit()
        lang_edit.setText(conf["lang"])
        lang_edit.setStyleSheet(settings["text_edit"])
        lang.addWidget(lang_label)
        lang.addWidget(lang_edit)
        tab_main_layout.addLayout(lang,0,2)
        qr_login=QCheckBox("使用二维码登陆")
        qr_login.setChecked(conf["qr_login"])
        qr_login.setStyleSheet(settings["check_box"])
        tab_main_layout.addWidget(qr_login,1,2)
        record_days=QHBoxLayout()
        record_days_label=QLabel("阅读记录保存天数：")
        record_days_label.setStyleSheet(settings["label"])
        record_days_edit=QLineEdit()
        record_days_edit.setText(str(conf["record_days"]))
        record_days_edit.setValidator(QIntValidator())
        record_days_edit.setStyleSheet(settings["text_edit"])
        record_days.addWidget(record_days_label)
        record_days.addWidget(record_days_edit)
        ...
        timeout_edit.setText(str(conf["timeout"]))
        timeout_edit.setValidator(QIntValidator())
        timeout_edit.setStyleSheet(settings["text_edit"])
        timeout.addWidget(timeout_label)
        timeout.addWidget(timeout_edit)
        tab_main_layout.addLayout(timeout,3,2)
        ui_at_top=QCheckBox("窗口置顶")
        ui_at_top.setChecked(conf["ui"]["at_top"])
        ui_at_top.setStyleSheet(settings["check_box"])
        tab_main_layout.addWidget(ui_at_top,4,2)
        ui_auto_start=QCheckBox("自动开始")
        ui_auto_start.setChecked(conf["ui"]["auto_start"])
        ui_auto_start.setStyleSheet(settings["check_box"])
        tab_main_layout.addWidget(ui_auto_start,1,3)
        theme_opacity=QHBoxLayout()
        theme_opacity_label=QLabel("窗口透明度：")
        theme_opacity_label.setStyleSheet(settings["label"])
        theme_opacity_slider=FixedSlider()
        theme_opacity_slider.setOrientation(Qt.Orientations.Horizontal)
        theme_opacity_slider.setMinimum(0)
        theme_opacity_slider.setMaximum(10)
        theme_opacity_slider.setValue(int(conf["ui"]["opacity"]*10))
        theme_opacity_slider.setStyleSheet(settings["slider"])
        theme_opacity.addWidget(theme_opacity_label)
        theme_opacity.addWidget(theme_opacity_slider)
        ...
        theme_close_button_style_edit=QLineEdit()
        theme_close_button_style_edit.setText(conf["ui"]["close_button_style"])
        theme_close_button_style_edit.setStyleSheet(settings["text_edit"])
        theme_close_button_style.addWidget(theme_close_button_style_label)
        theme_close_button_style.addWidget(theme_close_button_style_edit)
        ...
        theme_conf_button_icon_edit=QLineEdit()
        theme_conf_button_icon_edit.setText(conf["ui"]["conf_button_icon"])
        theme_conf_button_icon_edit.setStyleSheet(settings["text_edit"])
        theme_conf_button_color_label=QLabel("设置按钮的颜色：")
        theme_conf_button_color_label.setStyleSheet(settings["label"])
        theme_conf_button_color_edit=QLineEdit()
        theme_conf_button_color_edit.setText(conf["ui"]["conf_button_color"])
        theme_conf_button_color_edit.setStyleSheet(settings["text_edit"])
        theme_conf_button_style_label=QLabel("设置按钮的QSS样式：")
        theme_conf_button_style_label.setStyleSheet(settings["label"])
        theme_conf_button_style_edit=QLineEdit()
        theme_conf_button_style_edit.setText(conf["ui"]["conf_button_style"])
        theme_conf_button_style_edit.setStyleSheet(settings["text_edit"])
        theme_conf_button.addWidget(theme_conf_button_icon_label,0,0)
        theme_conf_button.addWidget(theme_conf_button_icon_edit,0,1)
        theme_conf_button.addWidget(theme_conf_button_color_label,1,0)
        theme_conf_button.addWidget(theme_conf_button_color_edit,1,1)
        theme_conf_button.addWidget(theme_conf_button_style_label,2,0)
        theme_conf_button.addWidget(theme_conf_button_style_edit,2,1)
        ...
        theme_icon_edit=QLineEdit()
        theme_icon_edit.setText(conf["ui"]["icon"])
        theme_icon_edit.setStyleSheet(settings["text_edit"])
        theme_icon.addWidget(theme_icon_label)
        theme_icon.addWidget(theme_icon_edit)
        ...
        theme_log_panel_style_edit=QLineEdit()
        theme_log_panel_style_edit.setText(conf["ui"]["log_panel_style"])
        theme_log_panel_style_edit.setStyleSheet(settings["text_edit"])
        ...
        theme_log_scroll_bar_style_edit=QLineEdit()
        theme_log_scroll_bar_style_edit.setText(conf["ui"]["log_scroll_bar_style"])
        theme_log_scroll_bar_style_edit.setStyleSheet(settings["text_edit"])
        theme_log_panel_style.addWidget(theme_log_panel_style_label,0,0)
        theme_log_panel_style.addWidget(theme_log_panel_style_edit,0,1)
        theme_log_panel_style.addWidget(theme_log_scroll_bar_style_label,1,0)
        theme_log_panel_style.addWidget(theme_log_scroll_bar_style_edit,1,1)
        ...
        theme_maximum_button_style_edit=QLineEdit()
        theme_maximum_button_style_edit.setText(conf["ui"]["maximum_button_style"])
        theme_maximum_button_style_edit.setStyleSheet(settings["text_edit"])
        theme_maximum_button_style.addWidget(theme_maximum_button_style_label)
        theme_maximum_button_style.addWidget(theme_maximum_button_style_edit)
        ...
        theme_minimum_button_style_edit=QLineEdit()
        theme_minimum_button_style_edit.setText(conf["ui"]["minimum_button_style"])
        theme_minimum_button_style_edit.setStyleSheet(settings["label"])
        theme_minimum_button_style.addWidget(theme_minimum_button_style_label)
        theme_minimum_button_style.addWidget(theme_minimum_button_style_edit)
        ...
        theme_qr_style_edit=QLineEdit()
        theme_qr_style_edit.setText(conf["ui"]["qr_style"])
        theme_qr_title_style_label=QLabel("登陆界面标题的QSS样式：")
        theme_qr_title_style_label.setStyleSheet(settings["label"])
        theme_qr_title_style_edit=QLineEdit()
        theme_qr_title_style_edit.setText(conf["ui"]["qr_title_style"])
        theme_qr_title_style_edit.setStyleSheet(settings["text_edit"])
        theme_qr_style.addWidget(theme_qr_style_label,0,0)
        theme_qr_style.addWidget(theme_qr_style_edit,0,1)
        theme_qr_style.addWidget(theme_qr_title_style_label,1,0)
        theme_qr_style.addWidget(theme_qr_title_style_edit,1,1)
        ...
        theme_start_button_edit=QLineEdit()
        theme_start_button_edit.setText(conf["ui"]["start_button"])
        theme_start_button_color_label=QLabel("开始按钮的颜色：")
        theme_start_button_color_label.setStyleSheet(settings["label"])
        theme_start_button_color_edit=QLineEdit()
        theme_start_button_color_edit.setText(conf["ui"]["start_button_color"])
        theme_start_button_color_edit.setStyleSheet(settings["text_edit"])
        theme_start_button_style_label=QLabel("开始按钮的QSS样式：")
        theme_start_button_style_label.setStyleSheet(settings["label"])
        theme_start_button_style_edit=QLineEdit()
        theme_start_button_style_edit.setText(conf["ui"]["start_button_style"])
        theme_start_button_style_edit.setStyleSheet(settings["text_edit"])
        theme_start_button.addWidget(theme_start_button_label,0,0)
        theme_start_button.addWidget(theme_start_button_edit,0,1)
        theme_start_button.addWidget(theme_start_button_color_label,1,0)
        theme_start_button.addWidget(theme_start_button_color_edit,1,1)
        theme_start_button.addWidget(theme_start_button_style_label,2,0)
        theme_start_button.addWidget(theme_start_button_style_edit,2,1)
        ...
        theme_title_colors_table=CustomListWidget()
        theme_title_colors_table.addItems(conf["ui"]["title_colors"])

        theme_title_colors_table.setStyleSheet(settings["list"])
        theme_title_style_label=QLabel("标题的QSS样式：")
        theme_title_style_label.setStyleSheet(settings["label"])
        theme_title_style_edit=QLineEdit()
        theme_title_style_edit.setText(conf["ui"]["title_style"])
        theme_title_style_edit.setStyleSheet(settings["text_edit"])
        theme_title.addWidget(theme_title_colors_label,0,0)
        theme_title.addWidget(theme_title_colors_table,0,1)
        theme_title.addWidget(theme_title_style_label,1,0)
        theme_title.addWidget(theme_title_style_edit,1,1)
        tab_theme_layout.addLayout(theme_title,4,1)
        tab_main.setLayout(tab_main_layout)
        tab_theme.setLayout(tab_theme_layout)
        dialog_layout.addWidget(tab)
    def mousePressEvent(self, event:QMouseEvent):
        super(SettingWindow,self).mousePressEvent(event)
        self.setFocus()
        self.m_flag=True
    ...
    def mouseMoveEvent(self, event:QMouseEvent):
        super(SettingWindow,self).mouseMoveEvent(event)
        if self.m_flag==True:
    ...
    def mouseReleaseEvent(self, event:QMouseEvent):
        super(SettingWindow,self).mouseReleaseEvent(event)
        self.m_flag=False
