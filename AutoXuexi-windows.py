...
browser_type=str(default_conf["browser_type"])
allow_upload=bool(default_conf["allow_upload"])
browser_exec=str(default_conf["browser_exec"])
driver_exec=str(default_conf["driver_exec"])
